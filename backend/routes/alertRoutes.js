...
const alertMiddleware = require("../middlewares/authMiddleware");
...
// @access  Private
router.get("/", alertMiddleware, async (req, res) => {
  try {
    const {
      read,
      type,
...
// @access  Private
router.get("/recent", alertMiddleware, async (req, res) => {
  try {
...
// @access  Private
router.get("/:id", alertMiddleware, async (req, res) => {
  try {
...
// @access  Private
router.put("/:id/read", alertMiddleware, async (req, res) => {
  try {
    const notification = await Notification.findOne({
      _id: req.params.id,
      userId: req.user.id,
...
// @access  Private
router.put("/:id/unread", alertMiddleware, async (req, res) => {
  try {
    const notification = await Notification.findOne({
      _id: req.params.id,
      userId: req.user.id,
...
// @access  Private
router.put("/read-all", alertMiddleware, async (req, res) => {
  try {
...
// @access  Private
router.delete("/:id", alertMiddleware, async (req, res) => {
  try {
...
// @access  Private
router.delete("/clear-read", alertMiddleware, async (req, res) => {
  try {
...
// @access  Private
router.delete("/clear-all", alertMiddleware, async (req, res) => {
  try {
    const result = await Notification.deleteMany({
      userId: req.user.id,
    });
...
// @access  Private
router.post("/bulk", alertMiddleware, async (req, res) => {
  try {
...
// @access  Private
router.get("/statistics", alertMiddleware, async (req, res) => {
  try {
...
// @access  Private
router.post("/preferences", alertMiddleware, async (req, res) => {
  try {
    const {
      emailNotifications,
      pushNotifications,
